...
Project.unit<0>.dataChannel<10>=bus_data<2>
Project.unit<0>.dataChannel<11>=bus_data<3>
Project.unit<0>.dataChannel<12>=bus_data<4>
Project.unit<0>.dataChannel<13>=bus_data<5>
Project.unit<0>.dataChannel<14>=bus_data<6>
Project.unit<0>.dataChannel<15>=bus_data<7>
Project.unit<0>.dataChannel<16>=bus_data<8>
Project.unit<0>.dataChannel<17>=bus_data<9>
Project.unit<0>.dataChannel<18>=bus_data<10>
Project.unit<0>.dataChannel<19>=bus_data<11>
Project.unit<0>.dataChannel<1>=bus_req<7>
Project.unit<0>.dataChannel<20>=bus_data<12>
Project.unit<0>.dataChannel<21>=bus_data<13>
Project.unit<0>.dataChannel<22>=bus_data<14>
Project.unit<0>.dataChannel<23>=bus_data<15>
Project.unit<0>.dataChannel<24>=bus_ctrller currentState<0>
Project.unit<0>.dataChannel<25>=bus_ctrller currentState<1>
Project.unit<0>.dataChannel<26>=bus_ctrller currentState<2>
Project.unit<0>.dataChannel<27>=bus_ctrller slave_en<2>
Project.unit<0>.dataChannel<28>=bus_ctrller slave_en<4>
Project.unit<0>.dataChannel<29>=bus_ctrller slave_en<7>
Project.unit<0>.dataChannel<2>=vga_ctrl buffer1 read_address<0>
Project.unit<0>.dataChannel<30>=vga_ctrl bus_if buf_write_addr<0>
Project.unit<0>.dataChannel<31>=vga_ctrl bus_if buf_write_addr<1>
Project.unit<0>.dataChannel<32>=vga_ctrl bus_if buf_write_addr<2>
Project.unit<0>.dataChannel<33>=sram_ctrl burst_counter<0>
Project.unit<0>.dataChannel<34>=sram_ctrl burst_counter<1>
Project.unit<0>.dataChannel<35>=sram_ctrl burst_counter<2>
Project.unit<0>.dataChannel<36>=sram_ctrl burst_counter<3>
Project.unit<0>.dataChannel<37>=sram_ctrl currentState<0>
Project.unit<0>.dataChannel<38>=sram_ctrl currentState<1>
Project.unit<0>.dataChannel<39>=sram_ctrl currentState<2>
Project.unit<0>.dataChannel<3>=vga_ctrl buffer1 read_address<1>
Project.unit<0>.dataChannel<40>=sram_ctrl currentState<3>
Project.unit<0>.dataChannel<41>=sram_ctrl maddr<0>
Project.unit<0>.dataChannel<42>=sram_ctrl maddr<1>
Project.unit<0>.dataChannel<43>=sram_ctrl maddr<2>
Project.unit<0>.dataChannel<44>=sram_ctrl maddr<3>
Project.unit<0>.dataChannel<45>=sram_ctrl maddr<4>
Project.unit<0>.dataChannel<46>=sram_ctrl maddr<5>
Project.unit<0>.dataChannel<47>=sram_ctrl maddr<6>
Project.unit<0>.dataChannel<48>=sram_ctrl maddr<7>
Project.unit<0>.dataChannel<49>=sram_ctrl maddr<8>
Project.unit<0>.dataChannel<4>=vga_ctrl buffer1 read_address<2>
Project.unit<0>.dataChannel<50>=sram_ctrl maddr<9>
Project.unit<0>.dataChannel<51>=sram_ctrl maddr<10>
Project.unit<0>.dataChannel<52>=sram_ctrl maddr<11>
Project.unit<0>.dataChannel<53>=sram_ctrl maddr<12>
Project.unit<0>.dataChannel<54>=sram_ctrl maddr<13>
Project.unit<0>.dataChannel<55>=sram_ctrl maddr<14>
Project.unit<0>.dataChannel<56>=sram_ctrl maddr<15>
Project.unit<0>.dataChannel<57>=sram_ctrl maddr<16>
Project.unit<0>.dataChannel<58>=sram_ctrl maddr<17>
Project.unit<0>.dataChannel<59>=sram_ctrl maddr<18>
Project.unit<0>.dataChannel<5>=vga_ctrl buffer1 we
Project.unit<0>.dataChannel<60>=sram_ctrl maddr<19>
Project.unit<0>.dataChannel<61>=sram_ctrl maddr<20>
Project.unit<0>.dataChannel<62>=sram_ctrl maddr<21>
Project.unit<0>.dataChannel<63>=sram_ctrl maddr<22>
Project.unit<0>.dataChannel<64>=vga_ctrl pixel<0>
Project.unit<0>.dataChannel<65>=vga_ctrl pixel<1>
Project.unit<0>.dataChannel<66>=vga_ctrl pixel<2>
Project.unit<0>.dataChannel<67>=vga_ctrl pixel<3>
Project.unit<0>.dataChannel<68>=vga_ctrl pixel<4>
Project.unit<0>.dataChannel<69>=vga_ctrl pixel<5>
Project.unit<0>.dataChannel<6>=vga_ctrl buffer1 write_address<0>
Project.unit<0>.dataChannel<70>=vga_ctrl pixel<6>
Project.unit<0>.dataChannel<71>=vga_ctrl pixel<7>
Project.unit<0>.dataChannel<72>=vga_ctrl buffer0 read_address<0>
Project.unit<0>.dataChannel<73>=vga_ctrl buffer0 read_address<1>
Project.unit<0>.dataChannel<74>=vga_ctrl buffer0 read_address<2>
Project.unit<0>.dataChannel<75>=vga_ctrl buffer0 we
Project.unit<0>.dataChannel<76>=vga_ctrl buffer0 write_address<0>
Project.unit<0>.dataChannel<77>=vga_ctrl buffer0 write_address<1>
Project.unit<0>.dataChannel<78>=vga_ctrl buffer0 write_address<2>
Project.unit<0>.dataChannel<7>=vga_ctrl buffer1 write_address<1>
Project.unit<0>.dataChannel<8>=bus_data<0>
Project.unit<0>.dataChannel<9>=bus_data<1>
